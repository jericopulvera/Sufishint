...
class DB
{
    ...
    public function select_fetch($query, $where = null, $order = null)
    { //order= "id, DESC"
        $query = explode('/', $query);
    ...
    public function select_rowCount($query, $where = null)
    {
        $query = explode('/', $query);
        $query = "SELECT $query[1] FROM $query[0]";
    ...
    public function delete($query, $where = null)
    {
        $query = "
			DELETE
			FROM $query
    ...
    public function getLicenseId($query)
    {
    ...
    public function insert_with_date($query)
    {
        $query = explode('/', $query);
        $query[2] = explode(', ', $query[2]);
        $query[2] = implode('\', \'', $query[2]);
    ...
    public function update($query, $where = null)
    { //UPDATE todo SET text = '1234', done = '1' WHERE id = '44';
    ...
    public function query_query($query)
    {
        $query = $this->_pdo->query($query);
    ...
    public function select_innerjoin()
    {
        $query = 'SELECT 
		posts.id AS post_id,
    ...
    public function exist($query, $where = null)
    {
        $query = explode('/', $query);
        $query =
            "
    ...
    public function get($query, $where = null)
